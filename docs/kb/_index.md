...
- `linux/` — apt, VeraCrypt, ssh permissions, systemd, docker (engine install + NVIDIA toolkit), Omarchy (`doc omarchy`: pacman, the bash-first login shell, the XDG tmux path)
