...
- `common/tools/` — per-tool cheat-sheets (eza, fzf, bat, fd, tree, ripgrep, zoxide, atuin, yazi, delta, starship, chezmoi, micro, glow, neovim, zed, cursor, wezterm, ghostty, grok, gemini, pi, llmfit, node-python, and the disk/monitor set: duf, ncdu, dust, gdu, btop, bottom, glances, bandwhich, gping, rclone) — `doc eza`, `doc nvim`, …
