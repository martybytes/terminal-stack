...
function Set-TerminalStackConfig {
    ...
    switch ($Action) {
        ...
        default { Write-Warning "tstack config: unknown command '$Action' (show, get, set, leader, theme, tmux, apps, tts, mux, restore, atuin, prompt, ghostty, herdr, memory, agents, wezterm, wizard)" }
    }
}
